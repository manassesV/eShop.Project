...
namespace eShop.Ordering.API.Application.IntegrationEvents
{
        ...
        ILogger<OrderingIntegrationEventService> logger) : IOrderingIntegrationEventService
    {
        ...
        private readonly OrderingContext _orderingContext = orderingContext ?? throw new ArgumentNullException(nameof(_orderingContext));
        ...
        public async Task PublishEventThroughtEventBusAsync(Guid transactionId)
        {
            ...
            foreach (var logEvt in pendingLogEvents)
            {
                ...
                catch (Exception ex)
                {
                    ...
                    await _eventLogService.MarkEventAsFailedAsync(transactionId);
                }
            }
        }
