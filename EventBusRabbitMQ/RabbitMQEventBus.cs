...
namespace eShop.EventBusRabbitMQ
{
        ...
        RabbitMQTelemetry rabbitMQTelemetry) : IEventBus, IDisposable, IHostedService
    {
        ...
        private readonly string _queeName = options.Value.SubscriptionClientName;
        ...
        private void SetActivityContext(Activity activity, string routingKey, string operation)
        {
