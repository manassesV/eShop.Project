...
public class ValueObjectTests
{
    ...
    public void Equals_EqualValueObjects_ReturnsTrue(ValueObject instanceA, ValueObjectB instanceB, string reason)
    {
        //Act
    ...
    public void Equals_NonEqualValueObjects_RetursFalse(ValueObject instanceA, ValueObject instanceB, string message)
    {
        //Act
        var result = EqualityComparer<ValueObject>.Default.Equals(instanceA, instanceB);
    ...
    private static readonly ValueObject
        APrettyValueObject = new ValueObjectA(1, "2",
        ...
        get
        {
            return new[]
            {
               ...
               new object[] {
                   ...
                   "they should be not be aqual because th c list contains one adicional value"
               },
               new object[] {
                   new ValueObjectB(1, "2", 1, 2, 3, 5),
                   new ValueObjectB(1, "2", 1, 2, 3),
                   "they should not be eual because c list contaisn one additional value"
               },
               new object[] {
                   new ValueObjectB(1, "2", 1, 2, 3, 5),
                   new ValueObjectB(1, "2", 1, 2, 3, 4),
                   "they should be not be equal because the c list are not equal"
               }
            };
        }
    }
   ...
   private class ValueObjectA: ValueObject
   {
        public ValueObjectA(
            ...
            Guid c,
            ComplexObject d,
            string notAnEqualityComponent = null)
        {
            A = a; 
            B = b; 
            C = c;
